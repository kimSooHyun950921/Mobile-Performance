...
moveServosTo = function(x, y, z) {
  ...
  //console.log("SERVO angles:"+angles);
  //console.log((angles[1]).map(config.servo1.in_min, config.servo1.in_max, config.servo1.out_min, config.servo1.out_max));
  //console.log((angles[2]).map(config.servo2.in_min, config.servo2.in_max, config.servo2.out_min, config.servo2.out_max));
  //console.log((angles[3]).map(config.servo3.in_min, config.servo3.in_max, config.servo3.out_min, config.servo3.out_max));
}
...
var go = function(x, y, z, easeType) {
  console.log('Greeting from bot.js!'+x+", "+y+", "+z);
  var pointB = [x, y, z];
  if (easeType == "none") {
